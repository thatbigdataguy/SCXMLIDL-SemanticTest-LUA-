local scriptTesty = require("scripts.util")
-- Meta class
CallBack = {area = 0}
...
function CallBackImpl:onExit ()
  -- print("onExit From CallBackImpl ")
   scriptTesty.checkCallBackType(CallBackType.onExit)
end
function CallBackImpl:onEntry ()
   --print("onEntry From CallBackImpl ")
   scriptTesty.checkCallBackType(CallBackType.onEntry)
end
function CallBackImpl:onTransition ()
   --print("onTransition From CallBackImpl ")
   scriptTesty.checkCallBackType(CallBackType.onTransition)
end
